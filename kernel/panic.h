...
__attribute__((noreturn)) void panic_impl(const char *msg, const panic_regs *regs);
...
#define panic(msg)                                                                                  \
  do {                                                                                              \
    panic_regs _r;                                                                                  \
    __asm__ volatile(/* save rax first so we can reuse it as scratch for RIP */                     \
                     "mov %%rax,%0\n\t"                                                             \
                     "mov %%rbx,%1\n\t"                                                             \
                     "mov %%rcx,%2\n\t"                                                             \
                     "mov %%rdx,%3\n\t"                                                             \
                     ...
                     : "=m"(_r.rax), "=m"(_r.rbx),                                                  \
                       ...
                       "=m"(_r.r12), "=m"(_r.r13),                                                  \
                       "=m"(_r.r14), "=m"(_r.r15),                                                  \
                       "=m"(_r.rip), "=m"(_r.rflags)::"rax", "memory");                             \
    panic_impl(msg, &_r);                                                                           \
  } while (0)
